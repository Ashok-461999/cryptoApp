...
class Settings(BaseSettings):
    ...
    scalp_min_confidence: int = 72
    live_min_confidence: int = 65
    normal_min_confidence: int = 62
    notify_min_confidence: int = 78
    ...
    mover_min_confidence: int = 65  # top 24h movers — easier entry bar
    meme_min_confidence: int = 65
